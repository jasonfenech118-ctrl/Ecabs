...
urlpatterns = [
    ...
    path("garage/<int:pk>/item/add/", views.garage_job_item_add, name="garage_job_item_add"),
    path("garage/<int:pk>/item/<int:item_pk>/delete/", views.garage_job_item_delete, name="garage_job_item_delete"),
