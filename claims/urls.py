...
urlpatterns = [
    ...
    path("sales/invoices/new/", views.sales_invoice_new, name="sales_invoice_new"),
    path("sales/invoices/<int:pk>/", views.sales_invoice_edit, name="sales_invoice_edit"),
    path("sales/invoices/<int:pk>/line/add/", views.sales_invoice_line_add, name="sales_invoice_line_add"),
    path("sales/invoices/<int:pk>/line/<int:line_pk>/", views.sales_invoice_line_update, name="sales_invoice_line_update"),
    path("sales/invoices/<int:pk>/pdf/", views.sales_invoice_pdf, name="sales_invoice_pdf"),
    path("sales/clients/", views.client_insurers, name="client_insurers"),
    path("parts/receipts/", views.parts_receipts, name="parts_receipts"),
    ...
    path("parts/receipts/<int:pk>/line/add/", views.parts_receipt_line_add, name="parts_receipt_line_add"),
    path("parts/receipts/<int:pk>/line/<int:line_pk>/", views.parts_receipt_line_update, name="parts_receipt_line_update"),
    ...
    path("general/", views.general_claims, name="general_claims"),
    path("general/new/", views.general_claim_edit, name="general_claim_new"),
    path("general/<int:pk>/edit/", views.general_claim_edit, name="general_claim_edit"),
    path("general/<int:pk>/toggle/", views.general_claim_toggle, name="general_claim_toggle"),
    path("general/<int:pk>/delete/", views.general_claim_delete, name="general_claim_delete"),
    ...
    path("vehicles/<int:pk>/cost/save/", views.vehicle_cost_save, name="vehicle_cost_save"),
    path("vehicles/<int:pk>/cost/<int:year>/delete/", views.vehicle_cost_delete, name="vehicle_cost_delete"),
    path("vehicles/cost/<int:cost_pk>/additional/add/", views.vehicle_additional_add, name="vehicle_additional_add"),
    path("vehicles/cost/<int:cost_pk>/additional/<int:item_pk>/delete/", views.vehicle_additional_delete, name="vehicle_additional_delete"),
