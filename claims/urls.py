...
urlpatterns = [
    ...
    path("garage/invoices/<int:pk>/delete/", views.garage_invoice_delete, name="garage_invoice_delete"),
    ...
    path("sales/invoices/<int:pk>/delete/", views.sales_invoice_delete, name="sales_invoice_delete"),
    ...
    path("parts/receipts/<int:pk>/delete/", views.parts_receipt_delete, name="parts_receipt_delete"),
